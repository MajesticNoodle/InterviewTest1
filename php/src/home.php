  ...
  <div>
    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body"> <?php
                                      ...
                                      ?> <div class="row">
          <div class="col-10">
            <h4 class="small font-weight-bold"> <?= ucwords($row['name']) ?> <?php
          ...
          <div class="col-2">
            <a href="./index.php?page=view_project&id=
								<?php echo $row['id'] ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"> View </a>
          </div>
        </div>
        <br> <?php endwhile; ?>
      </div>
